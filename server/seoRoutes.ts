...
export function buildLlmsTxt(origin = canonicalOrigin) {
  return `# HIPA Masala\n\n> HIPA Masala is a Chennai, Tamil Nadu, India spice and masala brand.\n\n## Business\n- Website: ${origin}/\n- Location: ${siteIdentity.locationLabel}\n- Phone: +91 70580 53055\n- Email: info@hipamasalas.com\n- WhatsApp: ${origin}/contact\n\n## Products\nHIPA Masala currently lists Sambar Powder, Rasam Powder, Turmeric Powder, Red Chilli Powder, Coriander Powder, Cumin Powder, Pepper Powder and Garam Masala. Product pages: ${origin}/products\n\n## Enquiries\nFor consumer product questions, distributor, wholesaler, retailer, supermarket, restaurant or exporter enquiries, use ${origin}/b2b-enquiries or ${origin}/contact. Commercial availability, pricing, delivery, manufacturing and export terms must be confirmed directly by HIPA Masala.\n\n## Public pages\n- Products: ${origin}/products\n- FAQ: ${origin}/faq\n- Contact: ${origin}/contact\n- Business enquiries: ${origin}/b2b-enquiries\n- Blog: ${origin}/blog\n`;
}
