...
export function SiteShell({ children }: { children: React.ReactNode }) {
  ...
  return <div>
    ...
    <header className={`site-header ${headerScrolled ? "scrolled" : ""}`}><div className="container header-inner">
      <Link href="/" className="brand" onClick={closeMenu} aria-label="HIPA Masala home"><img className="brand-logo-img" src={siteIdentity.logo} alt="HIPA Masala official logo" /><span className="brand-text"><span className="brand-name">HIPA</span><span className="brand-sub">Masala · Taste of Tradition</span></span></Link>
